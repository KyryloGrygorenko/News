...
//
//
//SELECT * FROM `articles` WHERE (`date` Between '2016-10-09' AND '2017-12-09') AND (`tags` LIKE '%politics%')
//
//SELECT * FROM `articles` WHERE (`date` Between '2016-10-09' AND '2017-12-09') AND (`tags` LIKE '%politics%') AND (`category_id`=2)
//}